...
public class FNode {
    ...
    // Override lexer recovery to throw exceptions on unrecognized
    // tokens.
    //
    // Adapted from The Definitive ANTLR 4 Reference, 2nd Edition" section 9.5
    static class BailFormulaLexer extends FormulaLexer {
        public BailFormulaLexer(CharStream input) { super(input); }
        public void recover(LexerNoViableAltException e) {
            throw new RuntimeException(e);// Bail out
        }
    }

    static class BailErrorStrategy extends DefaultErrorStrategy {
    ...
    public static FNode parseFormulaString(String formulaStr){
        ...
        FormulaLexer lexer = new BailFormulaLexer(input);
    ...
    public static void main(String[] args) throws Exception {
        if(args.length < 1){
            System.out.println("usage:   java -jar formula.jar FNode 'formula to interpret'");
            System.out.println("Example: java -jar formula.jar FNode '=A1 + -5.23 *(2+3+A4) / ZD11'");
            return;
        }
